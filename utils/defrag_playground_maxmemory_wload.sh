...
launch_loader() {
  ...
  kill_loader
  sleep 2
  nohup ./valkey-benchmark -c 80 -r 2000000000 -t set -d 24 -q -l&
  nohup ./valkey-benchmark -c 80 -r 2000000000 -t set -d 128 -q -l&
  nohup ./valkey-benchmark -c 80 -r 1500000000 -t set -d 212 -q -l&
  nohup ./valkey-benchmark -c 80 -r 50000000 -t set -d 1234 -q -l&
  nohup ./valkey-benchmark -c 80 -r 20000000 -t set -d 234 -q -l&
  nohup ./valkey-benchmark -c 80 -r 2000000000 -t set -d 74 -q -l&
  nohup ./valkey-benchmark -c 80 -r 100000000 -t set -d 256 -q -l&
  nohup ./valkey-benchmark -c 80 -r 25000000 -t set -d 123 -q -l&
...
launch_loader_partial() {
  echo "launch_loader:${LINENO}:$@"
  kill_loader
  sleep 2
  nohup ./valkey-benchmark -c 80 -r 400000000 -t set -d 24 -q -l&
  nohup ./valkey-benchmark -c 80 -r 400000000 -t set -d 128 -q -l&
  nohup ./valkey-benchmark -c 80 -r 150000000 -t set -d 212 -q -l&
  nohup ./valkey-benchmark -c 80 -r 5000000 -t set -d 1234 -q -l&
  nohup ./valkey-benchmark -c 80 -r 9000000 -t set -d 234 -q -l&
  nohup ./valkey-benchmark -c 80 -r 600000000 -t set -d 74 -q -l&
  nohup ./valkey-benchmark -c 80 -r 10000000 -t set -d 256 -q -l&
  nohup ./valkey-benchmark -c 80 -r 2500000 -t set -d 123 -q -l&
  echo "[${LINENO}][$LOOPS]:$(($(date +%s) - start_t)):started loaders: $(ps -ef | grep valkey)" >> "$filename"
  echo "[${LINENO}][$LOOPS]:$(($(date +%s) - start_t)):started loaders: $(ps -ef | grep valkey)"
}
...
start_defrag() {
  echo "[${LINENO}][$LOOPS]:[$1]:start_defrag:$@"
...
# if statement to apply config based on value of $1
  if [ "$1" -eq 0 ]; then
    ...
    rotate_defrag_config "all" "full_cycle" "none" 125 "none" "none"
  elif [ "$1" -eq 3 ]; then
    rotate_defrag_config "je-ctl" "none" "none" 300 "none" "none"
  elif [ "$1" -eq 4 ]; then
    rotate_defrag_config "je-ctl" "none" "none" 1000 "none" "none"
  fi
...
#  rotate_defrag_config "je-ctl" "full_cycle" "progressive" 2999 "ud-tcache" "ud-tcache"
  ...
  echo "[${LINENO}][$LOOPS]:[$1]:start_defrag:$@ : DONE"
...
filename="defrag_maxmem_wload_${SERVER}.${timestamp}.${MIN_USED_MEMORY}.log"
touch "$filename"
