...
After successful installation, proceed to the [User Guide](USER_GUIDE.md) for detailed usage instructions.

## Quick Installation Test

After installation, run this quick test to verify everything works:
